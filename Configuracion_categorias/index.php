    ...
    <form action="./enviar.php" method="POST" class="formulario">
        ...
        <div class="a1">
            ...
            <div>
                ...
                <a href="../Configuracion_categorias_actualizar/index.php?id_categorias=<?php echo $product -> id_categorias?> & nombre_categorias=<?php echo $product->nombre_categorias?>" class="boton_cancelar boton_selec">Editar</a>
                <a href="./borrar.php?id_categorias=<?php echo $product -> id_categorias ?>" class="boton_cancelar boton_selec">Borrar</a>
