    ...
    <form action="./enviar.php" method="POST" class="formulario">
        ...
        <div class="a1">
            ...
            <div>
                ...
                <a href="../Configuracion_ciudades_actualizar/index.php?id_ciudad=<?php echo $product -> id_ciudad?> & nombre_ciudad=<?php echo $product->nombre_ciudad?>" class="boton_cancelar boton_selec">Editar</a>
                <a href="./borrar.php?id_ciudad=<?php echo $product -> id_ciudad ?>" class="boton_cancelar boton_selec">Borrar</a>
